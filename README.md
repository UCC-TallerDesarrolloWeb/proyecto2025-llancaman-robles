...
- Visualización de imágenes interactivas (360°).
...
- **Modelos:** Listado de autos con imágenes y fichas técnicas.  
- **Filtros avanzados:** Selección por categoría, precio y marca.  
- **Galería:** Fotos en alta calidad.  
...
## 📌 Notas adicionales
- Este proyecto fue desarrollado para el **Primer Parcial de Taller de Desarrollo Web**.  
- El repositorio sigue la estructura solicitada:  
  `Proyecto2025-Llancaman-Robles`  
